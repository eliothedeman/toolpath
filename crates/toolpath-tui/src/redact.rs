...
/// Build a redacted toolpath Document from the original path and the entries with redaction state.
pub fn build_redacted_document(original: &v1::Path, entries: &[StepEntry]) -> v1::Document {
